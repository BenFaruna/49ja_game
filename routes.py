...
from utils.helper import compute_analytics, parse_datetime_param
...
@router.route("/history", strict_slashes=False)
def history():
...
@router.route("/history/export", strict_slashes=False)
def export_csv():
